...
export const GUIDES: Guide[] = [
  {
    ...
    description:
      '観葉植物によくつくコバエ（キノコバエ）・ハダニ・カイガラムシの見分け方と、それぞれの原因・対処法・予防法をまとめました。紹介している5種の「虫のつきにくさ」の比較もあります。',
    summary:
  ...
  },
  {
    ...
    description:
      '犬や猫と暮らしている人向けに、紹介している5種のうち安全性が確認されている植物と、そのほかの植物を置く場合の注意点（含まれる成分・症状・置き方の工夫）をまとめました。',
    summary:
      '「うちの子が齧っても大丈夫かな」が気になる人へ。5種のうち非毒性とされているのはどれか、ほかを置くならどう気をつけるかをまとめました。',
    lead:
      '犬や猫と暮らしていると、観葉植物を選ぶときにどうしても気になるのが「誤食」の心配ですよね。' +
      '私自身、植物を置くたびに「これ、うちの子が齧っても大丈夫かな」と気になってしまいます。' +
      'ここでは、今回紹介している5種の中で実際に安全性が確認されている植物と、他の植物を' +
      '置く場合の注意点をまとめました。',
